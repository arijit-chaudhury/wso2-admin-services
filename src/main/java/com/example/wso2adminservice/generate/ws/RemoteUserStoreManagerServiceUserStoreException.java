...
public class RemoteUserStoreManagerServiceUserStoreException {
    ...
    protected JAXBElement<UserStoreException2> userStoreException;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link UserStoreException2 }{@code >}
     *     
     */
    public JAXBElement<UserStoreException2> getUserStoreException() {
     ...
     *     
     */
    public void setUserStoreException(JAXBElement<UserStoreException2> value) {
